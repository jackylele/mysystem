...
public class MmybatisplusUtil {

    public static void main(String[] args) {
        String[] models = {"ssm-mapper"};
    ...
    private static void shell(String model){
       ...
       /* dsc.setTypeConvert(new MySqlTypeConvert(){
        ...
        dsc.setUrl("jdbc:mysql:///system?characterEncoding=utf8");
        ...
        strategy.setInclude(new String[] { "user","permission","role","role_permission","user_role" }); // 需要生成的表
